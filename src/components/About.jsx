        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          <div className='grid grid-cols-2 gap-6 md:gap-8 w-full 2xl:pr-28'>
            ...
            <div>
              ...
              <p>Ongoing Excellence</p>
            </div>
          </div>
          <p className='my-10 max-w-lg text-center md:text-left'>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, molestias impedit illum vitae dicta ea error
            consequuntur aut ipsa corrupti animi? Error enim officiis, debitis nobis ullam eveniet perferendis fugiat!
          </p>
